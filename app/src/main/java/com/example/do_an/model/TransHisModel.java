...
public class TransHisModel {
    ...
    public TransHisModel() {}

    public TransHisModel(String idCT, long tienNap) {
        this.idNT = idNT;
        this.tienNap = tienNap;
    }
    public TransHisModel(String idCT, long tienChuyen, String nd, long soDu) {
        this.idCT = idCT;
        this.tienChuyen = tienChuyen;
        this.nd = nd;
        this.sdCT = soDu;
    }
    public TransHisModel(String idRT, long tienRut, String nd) {
        this.idRT = idRT;
