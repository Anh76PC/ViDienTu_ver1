...
import com.example.do_an.adapter.PrefereAdminAdapter;
...
public class PrefereAdminActivity extends AppCompatActivity {
    ...
    private void updateRecyclerView(List<UuDaiModel> uuDaiList) {
        ...
        PrefereAdminAdapter uuDaiAdminAdapter = new PrefereAdminAdapter(uuDaiList, this);
