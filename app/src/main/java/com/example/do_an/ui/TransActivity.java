        ...
        btCT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (phoneNumber.isEmpty() || amountStr.isEmpty()) {
                    Toast.makeText(TransActivity.this, "Chưa nhập đủ thông tin", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void updateNotification(String phoneNumber1, String titletran, String pricetran, String date, String hour){
        ...
        transactionInfoDocRef.collection("ChuyenTien").add(newTransactionMap)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(TransActivity.this, "Giao dịch đã được thêm vào Firebase", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(TransActivity.this, "Lỗi khi thêm giao dịch vào Firebase: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(TransActivity.this, "Chuyển tiền thất bại", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                                } else {
                                    Toast.makeText(TransActivity.this, "Số dư không đủ để thực hiện giao dịch", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(TransActivity.this, "Không tìm thấy tài khoản chuyển tiền", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(TransActivity.this, "Lỗi khi truy vấn dữ liệu", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
                            ...
                            if (receiverDocument.exists()) {
                                ...
                                db.collection("Users").document(receiverPhoneNumber)
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    Toast.makeText(TransActivity.this, "Chuyển tiền thành công", Toast.LENGTH_SHORT).show();
                                                    numberOfNotifications++;
                                                } else {
                                                    Toast.makeText(TransActivity.this, "Chuyển tiền thất bại", Toast.LENGTH_SHORT).show();
                                                }
                                                finish(); // Finish the WithdActivity

                                            }
                                        });
                            } else {
                                Toast.makeText(TransActivity.this, "Không tìm thấy tài khoản nhận tiền", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(TransActivity.this, "Lỗi khi truy vấn dữ liệu", Toast.LENGTH_SHORT).show();
                        }
