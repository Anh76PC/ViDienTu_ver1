        ...
        btdone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edMK1.getText().toString().isEmpty() || edMK3.getText().toString().isEmpty()) {
                    Toast.makeText(ForgotPassActivity.this, "Chưa nhập đủ thông tin", Toast.LENGTH_SHORT).show();
                } else if (!edMK1.getText().toString().equals(edMK3.getText().toString())) {
                    Toast.makeText(ForgotPassActivity.this, "Mật khẩu xác nhận không đúng", Toast.LENGTH_SHORT).show();

                } else if (edMK1.getText().toString().length() < 6 || edMK3.getText().toString().length() < 6  || !edMK1.getText().toString().matches("^[0-9]+$")) {
                    Toast.makeText(ForgotPassActivity.this, "Mật khẩu phải là 6 chữ số", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ForgotPassActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show(); // Khi lưu thất bại
                        }
                    }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ForgotPassActivity.this, "Đăng ký thành công", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(ForgotPassActivity.this, "Đăng ký thất bại", Toast.LENGTH_LONG).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ForgotPassActivity.this, "Đăng ký thất bại", Toast.LENGTH_SHORT).show();
                    }
                });
    }
