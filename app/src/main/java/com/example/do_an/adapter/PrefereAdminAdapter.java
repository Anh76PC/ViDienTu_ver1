...
public class PrefereAdminAdapter extends RecyclerView.Adapter<PrefereAdminAdapter.UuDaiViewHolder> {
    private List<UuDaiModel> uuDaiList;
    private Context context;

    public PrefereAdminAdapter(List<UuDaiModel> uuDaiList, Context context) {
