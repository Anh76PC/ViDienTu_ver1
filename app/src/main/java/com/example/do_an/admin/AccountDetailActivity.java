...
import com.example.do_an.ui.TransactionHistoryActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AccountDetailActivity.this, WalletBalanceActivity.class);
        ...
        ttcnadmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AccountDetailActivity.this, PersonalInformationActivity.class);
        ...
        lsgdadmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AccountDetailActivity.this, TransactionHistoryActivity.class);
                startActivity(intent);
            }
        });
        ...
        db.collection("Users").document(userAccountId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(AccountDetailActivity.this, "Tài khoản đã được khóa", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(AccountDetailActivity.this, "Khóa tài khoản thất bại", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        db.collection("Users").document(userAccountId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(AccountDetailActivity.this, "Tài khoản đã được mở khóa", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        // Xử lý khi không thể cập nhật trạng thái tài khoản
                        Toast.makeText(AccountDetailActivity.this, "Mở khóa tài khoản thất bại", Toast.LENGTH_SHORT).show();
                    }
                });
    }
